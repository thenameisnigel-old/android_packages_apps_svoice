...
public class HelpEditWhatYouSaidScreen extends WhatCanISayScreen
{
  private static int mTheme = 2131296526;
  private boolean customTitleSupported = false;
  private ImageView imgEditWhatYouSaid;
  ...
  protected void init()
  {
    ...
    if (isDialogMode())
    {
      ...
      if (localActionBar2 != null)
      {
        ...
        localActionBar2.getCustomView().setOnTouchListener(new HelpEditWhatYouSaidScreen.1(this));
      }
      ImageButton localImageButton = (ImageButton)findViewById(2131558546);
      if (localImageButton != null)
        localImageButton.setOnClickListener(new HelpEditWhatYouSaidScreen.2(this));
      ...
      if ((getWindowManager().getDefaultDisplay().getRotation() == 1) || (getWindowManager().getDefaultDisplay().getRotation() == 3))
      {
        ...
        ((TextView)findViewById(2131558641)).setText(getString(2131362506));
      }
    }
    while (true)
    {
      ...
      this.imgEditWhatYouSaid = ((ImageView)findViewById(2131558637));
      return;
      f1 = 476.0F * localDisplayMetrics.density;
      f2 = 704.0F * localDisplayMetrics.density;
      ...
      localActionBar1.setTitle(getString(2131362506));
    }
  }
  ...
  protected void onResume()
  {
    ...
    this.imgEditWhatYouSaid.setImageResource(2130838173);
    this.imgEditWhatYouSaid.invalidate();
 ...
 * Qualified Name:     com.vlingo.midas.help.HelpEditWhatYouSaidScreen
