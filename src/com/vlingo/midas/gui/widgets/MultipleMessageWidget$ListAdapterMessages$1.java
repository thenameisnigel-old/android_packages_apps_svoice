...
class MultipleMessageWidget$ListAdapterMessages$1
  implements View.OnClickListener
{
  public void onClick(View paramView)
  {
    ...
    localIntent.putExtra("id", this.val$message.getId());
 ...
 * Qualified Name:     com.vlingo.midas.gui.widgets.MultipleMessageWidget.ListAdapterMessages.1
