...
class NaverLocalWidget$1
  implements Runnable
{
  public void run()
  {
    String str1 = NaverLocalWidget.access$000(this.this$0).getMapImageUrl();
    if (str1 == null);
    while (true)
    {
      return;
      ...
      try
      {
        ...
        try
        {
          ...
          while (true)
          {
            ...
            if (str3 == null)
              break;
            Toast.makeText(NaverLocalWidget.access$100(this.this$0), str3, 0).show();
          }
        }
      ...
      continue;
      label149: new Handler(this.this$0.getContext().getMainLooper()).postDelayed(new NaverLocalWidget.1.1(this, localBitmap), 500L);
    }
  }
}

/* Location:           C:\Users\nigeluno\Desktop\APK2Java\tools\classes-dex2jar.jar
 * Qualified Name:     com.vlingo.midas.gui.widgets.NaverLocalWidget.1
