...
public class PlayTitleAction extends DMAction
  implements PlayMusicInterface
{
  ...
  public PlayTitleAction playlist(MusicUtil.MusicInfo paramMusicInfo)
  {
 ...
 * Qualified Name:     com.vlingo.midas.dialogmanager.actions.PlayTitleAction
