...
public class PlayAlbumAction extends DMAction
  implements PlayMusicInterface
{
  ...
  public Intent getLaunchIntent(String paramString)
  {
    ...
    localIntent.putExtra("android.intent.extra.focus", "vnd.android.cursor.item/album");
    localIntent.putExtra("android.intent.extra.album", paramString);
    return localIntent;
  }

  public PlayAlbumAction playlist(MusicUtil.MusicInfo paramMusicInfo)
  {
 ...
 * Qualified Name:     com.vlingo.midas.dialogmanager.actions.PlayAlbumAction
