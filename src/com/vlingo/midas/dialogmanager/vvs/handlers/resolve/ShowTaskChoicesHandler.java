...
public class ShowTaskChoicesHandler extends VVSActionHandler
  implements WidgetActionListener
{
  ...
  public boolean executeAction(VLAction paramVLAction, VVSActionHandlerListener paramVVSActionHandlerListener)
  {
    ...
    this.listUtil.showChoiceListWidget(paramVVSActionHandlerListener, paramVLAction, DialogDataType.TASK_MATCHES, WidgetUtil.WidgetKey.ShowTaskChoices, this, null);
    return false;
  }
 ...
 * Qualified Name:     com.vlingo.midas.dialogmanager.vvs.handlers.resolve.ShowTaskChoicesHandler
