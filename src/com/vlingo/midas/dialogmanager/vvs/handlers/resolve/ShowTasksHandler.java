...
public class ShowTasksHandler extends VVSActionHandler
  implements WidgetActionListener
{
  private DialogDataUtil.ChoiceListUtil<ScheduleTask> listUtil = new DialogDataUtil.ChoiceListUtil();

  public boolean executeAction(VLAction paramVLAction, VVSActionHandlerListener paramVVSActionHandlerListener)
  {
    super.executeAction(paramVLAction, paramVVSActionHandlerListener);
    VLActionUtil.getParamString(paramVLAction, "choices", true);
    this.listUtil.showChoiceListWidget(paramVVSActionHandlerListener, paramVLAction, DialogDataType.TASK_MATCHES, WidgetUtil.WidgetKey.ShowTaskChoices, WidgetUtil.WidgetKey.AddTask, this, null);
    return false;
  }
 ...
 * Qualified Name:     com.vlingo.midas.dialogmanager.vvs.handlers.resolve.ShowTasksHandler
