...
public class EditTaskAcceptedText extends AcceptedText
{
  ...
  public EditTaskAcceptedText(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    super(null);
  ...
  protected String getAcceptedTextXML()
  {
    ...
    localStringBuffer.append("<AcceptedText pt=\"task:edit\">");
    if (this.date != null)
    {
 ...
 * Qualified Name:     com.vlingo.core.internal.recognition.acceptedtext.EditTaskAcceptedText
