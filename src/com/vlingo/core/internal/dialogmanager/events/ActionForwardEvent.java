...
public class ActionForwardEvent extends DialogEvent
{
  private final String FIELDID_FIELD_NAME = "fieldid";
  private final String ID_FIELD_NAME = "id";
  private final String NAME = "action-forward";
  ...
  public ActionForwardEvent(long paramLong, String paramString1, String paramString2, String paramString3)
  {
  ...
  {
    VLDialogEvent.Builder localBuilder = new VLDialogEvent.Builder("action-forward");
 ...
 * Qualified Name:     com.vlingo.core.internal.dialogmanager.events.ActionForwardEvent
